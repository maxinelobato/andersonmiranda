    ...
    },
    {
      icon: (
        <svg
          ...
          viewBox="0 0 256 256"
        >
          <path d="M192,48H168V24A24,24,0,0,0,144,0H112A24,24,0,0,0,88,24V48H64A16,16,0,0,0,48,64V208a16,16,0,0,0,16,16H80v16a8,8,0,0,0,16,0V224h64v16a8,8,0,0,0,16,0V224h16a16,16,0,0,0,16-16V64A16,16,0,0,0,192,48ZM96,192a8,8,0,0,1-16,0V80a8,8,0,0,1,16,0Zm40,0a8,8,0,0,1-16,0V80a8,8,0,0,1,16,0ZM152,48H104V24a8,8,0,0,1,8-8h32a8,8,0,0,1,8,8Zm24,144a8,8,0,0,1-16,0V80a8,8,0,0,1,16,0Z"></path>
        </svg>
      ),
      title: 'Viajar Mais',
    },
          ...
          <div className="grid gap-10 lg:grid-cols-2">
                ...
                <ul className="space-y-2">
                  {features.map((item, idx) => (
                    <li key={idx} className="flex gap-x-4">
                      <div className="flex h-8 w-8 flex-none items-center justify-center rounded-lg text-orange-500">
                        {item.icon}
                      </div>
                      <div>
            ...
            <div className="-mx-4 flex items-center justify-center lg:pl-8">
              <div className="flex flex-col items-end px-3">
                <Image
                  className="mb-6 h-28 w-28 rounded border-s-4 border-orange-500/80 object-cover shadow-lg shadow-orange-500/80 sm:h-48 sm:w-48 xl:h-56 xl:w-56"
                  width={600}
                  height={600}
                ...
                />
                <Image
                  className="h-20 w-20 rounded border-s-4 border-orange-500/80 object-cover shadow-lg shadow-orange-500/80 sm:h-36 sm:w-36 xl:h-44 xl:w-48"
                  width={600}
                  height={600}
              ...
              <div className="px-3">
                <Image
                  className="h-40 w-40 rounded border-s-4 border-orange-500/80 object-cover shadow-lg shadow-orange-500/80 sm:h-64 sm:w-64 xl:h-80 xl:w-80"
                  width={600}
                  height={600}
