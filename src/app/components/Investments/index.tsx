export default function Investments() {
  ...
  return (
    <>
      <div className="bg-[url(https://images.unsplash.com/photo-1533659124865-d6072dc035e1?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=464&q=80)] bg-cover bg-fixed bg-no-repeat">
          ...
          <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
            ...
            <div className="mt-14 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
              {featuresinvestments.map((item, idx) => (
                <div
                  key={idx}
                  className="group block rounded-lg border-l-4 border-orange-400 bg-white/5 p-8 shadow-lg shadow-orange-400/70 backdrop-blur-sm"
                >
                  <div>
                    {item.icon}
